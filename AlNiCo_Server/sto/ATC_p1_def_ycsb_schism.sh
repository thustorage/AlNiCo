...
for((j=0;j<${#zipf[*]};j+=1));
    do
        ...
        zz=${zipf[$j]} 
        # make clean
        FLAGS='NDEBUG=1 MAX_THREAD=20 YCSBplusT=1  CPUBASED=4 STRIFE=1 YCSBTZIPF='$zz' YCSBSIZE='$size' YCSBCOL='$col'' 
        make -j $TARGET $FLAGS 
        mv $TARGET $BINARY
        ...
        # gdb ./ycsb_bench-net
        ./ycsb_bench-net -t20 -mA -idefault -g | tee -a /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/ATC_p1_def_ycsb_schism.txt
