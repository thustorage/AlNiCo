...
for((j=0;j<${#zipf[*]};j+=1));
    do
        ...
        zz=${zipf[$j]} 
        # make clean
        FLAGS='NDEBUG=1 MAX_THREAD=20 DYNAMIC=1 YCSBplusT=1 BASELINE=1 CPUBASED=4 STRIFE=1 YCSBTZIPF='$zz' YCSBSIZE='$size' YCSBCOL='$col'' 
        make -j $TARGET $FLAGS 
        mv $TARGET $BINARY
        ...
        # gdb ./ycsb_bench-net
        # ./ycsb_bench-net -t20 -mA -idefault -g | tee -a ATC_p3_dynamic_NetSTO_w$ww.txt
...
mv /home/ljr/AlNiCo-ATC22/AlNiCo_Server/sto/tp_listen_NetSTO.txt /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/tp_listen_NetSTO.txt
mv /home/ljr/AlNiCo-ATC22/Clients/NetTx/build/test/latency_ycsb_latency.txt /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/latency_dynamic_NetSTO_lat.txt
