...
struct ycsb_txn_t {
    ycsb_txn_t() : rw_txn(false), cnt(0), ops() {}
...
public:
    ...
    inline void next_tx(ycsb_txn_t*  new_ycsb_txn, int txn_sizez);
    inline void msg_next_tx(ycsb_txn_t* new_ycsb_txn, worker_msg_t* work_msg);
    void init(){
        dist_init();
    }
    ...
    inline void run_txn(ycsb_txn_t * txn, worker_msg_t* work_msg);
