...
do
    ...
    ./tpcc_pic_cpu_client_SPNIC20_zipf_warehouse.sh 20 100 24 $aa


    cd /home/ljr/AlNiCo-ATC22/AlNiCo_Server/sto 

    # gdb ./tpcc_bench-occ | tee -a tpcc_gdb.txt 
    # gdb -ex=r --args ./tpcc_bench-occ -t20 -idefault -x -w20 -r1000 | tee  p1_tpcc_high_partition_zipf.txt 

    ./tpcc_bench-occ -t20 -idefault -x -w20 -r1000  | tee -a /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/ATC_p1_b_tpcc_zipf_schism.txt
