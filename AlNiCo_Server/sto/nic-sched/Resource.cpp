    ...
    uint32_t qpsMaxDepth, uint32_t maxInlineData)
{
    ...
    attr.cap.max_send_wr = 2 * BatchPollSend;
    attr.cap.max_recv_wr = 2 * BatchPostRec;
    ...
    uint32_t qpsMaxDepth, uint32_t maxInlineData)
{
    ...
    dAttr.access_flags = IBV_ACCESS_REMOTE_READ | IBV_ACCESS_REMOTE_READ | IBV_ACCESS_REMOTE_ATOMIC;
