...
do
    tt=${thread[$i]}
    # make clean
    FLAGS='NDEBUG=0 OBSERVE_C_BALANCE=1 FINE_GRAINED=1 INLINED_VERSIONS=1 MAX_THREAD='$tt' ASYNCTXNUM=4 CLIENT_THREAD=24'
    make -j $TARGET $FLAGS 
    mv $TARGET $BINARY
    ...
    ./tpcc_bench-occ -t$tt -idefault -x -w2 -r1000  | tee -a /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/ATC_p4_occ_alnico.txt
...
do
    ...
    ./tpcc_bench-occ -t$tt -idefault -x -w2 -r1000  | tee -a /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/ATC_p4_occ_colocate.txt
...
do
    ...
    ./tpcc_bench-occ -t$tt -idefault -x  -w2 -r1000  | tee -a /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/ATC_p4_occ_central.txt
...
do
    ...
    ./tpcc_bench-occ -t$tt -idefault -x  -w2 -r1000  | tee -a /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/ATC_p4_occ_NetSTO.txt
