...
do
    nn=${client[$i]}
    FLAGS='NDEBUG=1 OBSERVE_C_BALANCE=1 BASELINE=1 CPUBASED=4 STRIFE=1 FINE_GRAINED=1 INLINED_VERSIONS=1 MAX_THREAD=20 ASYNCTXNUM=1 CLIENT_THREAD='$nn''
    make -j $TARGET $FLAGS 
    mv $TARGET $BINARY
    ...
    ./tpcc_bench-occ -t20 -idefault -x  -w2 -r1000  | tee -a /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/ATC_p2_tpcc_lat_NetSTO.txt
...
mv /home/ljr/AlNiCo-ATC22/Clients/NetTx/build/test/latency_tpcc_new_order.txt /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/latency_tpcc_new_order_NetSTO.txt
mv /home/ljr/AlNiCo-ATC22/Clients/NetTx/build/test/latency_tpcc_delivery.txt /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/latency_tpcc_delivery_NetSTO.txt
