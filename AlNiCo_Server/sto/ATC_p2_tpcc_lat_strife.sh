...
do
    nn=${client[$i]}
    FLAGS='NDEBUG=1 OBSERVE_C_BALANCE=1 CPUBASED=3 STRIFE=1 FINE_GRAINED=1 INLINED_VERSIONS=1 MAX_THREAD=20 ASYNCTXNUM=2 CLIENT_THREAD='$nn''
    make -j $TARGET $FLAGS 
    mv $TARGET $BINARY

    cd /home/ljr/AlNiCo-ATC22/Clients/NetTx/script

    ./tpcc_pic_cpu_client_strife.sh 20 100 $nn 2

    cd /home/ljr/AlNiCo-ATC22/AlNiCo_Server/sto 

    ./tpcc_bench-occ -t20 -idefault -x  -w2 -r1000  | tee -a /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/ATC_p2_tpcc_lat_strife.txt
...
mv /home/ljr/AlNiCo-ATC22/Clients/NetTx/build/test/latency_tpcc_new_order.txt /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/latency_tpcc_new_order_strife.txt
mv /home/ljr/AlNiCo-ATC22/Clients/NetTx/build/test/latency_tpcc_delivery.txt /home/ljr/AlNiCo-ATC22/ATC22AE/outfile/latency_tpcc_delivery_strife.txt
