...
bool modifyQPtoRTR(struct ibv_qp *qp, uint32_t remoteQPN, uint16_t remoteLid,
    ...
    fillAhAttr(&attr.ah_attr, remoteLid, remoteGid, context, 0);
...
bool modifyDCtoRTS(struct ibv_qp *qp, uint16_t remoteLid, uint8_t *remoteGid, RdmaContext *context, uint64_t interface_id) {
    ...
    fillAhAttr(&attr.ah_attr, remoteLid, remoteGid, context, interface_id); 
