...
###
 ...
 # @LastEditTime: 2022-01-09 17:14:34
...
sed -i s#YYYYY1#YCSBCOL=$4#g CMakeLists.txt
sed -i s#YYYYY2#SPNICXX#g CMakeLists.txt
sed -i s#YYYYY3#SPNIC2#g CMakeLists.txt
sed -i s#YYYYY4#YCSBHOT#g CMakeLists.txt
...
echo "go"
ssh root@10.0.2.113 "cd /home/ljr/AlNiCo-ATC22/Clients/NetTx/build/test; ./strife_client 1 0 >/dev/null 2>&1 &"
ssh root@10.0.2.111 "cd /home/ljr/AlNiCo-ATC22/Clients/NetTx/build/test; ./strife_client 2 0 >/dev/null 2>&1 &"
