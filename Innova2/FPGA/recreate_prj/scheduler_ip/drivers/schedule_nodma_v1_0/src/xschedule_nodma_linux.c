...
typedef struct {
    ...
    XSchedule_nodma_uio_map maps[ MAX_UIO_MAPS ];
} XSchedule_nodma_uio_info;

/***************** Variable Definitions **************************************/
static XSchedule_nodma_uio_info uio_info;
...
static int uio_info_read_name(XSchedule_nodma_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XSchedule_nodma_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XSchedule_nodma_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XSchedule_nodma_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XSchedule_nodma_Initialize(XSchedule_nodma *InstancePtr, const char* InstanceName) {
	XSchedule_nodma_uio_info *InfoPtr = &uio_info;
