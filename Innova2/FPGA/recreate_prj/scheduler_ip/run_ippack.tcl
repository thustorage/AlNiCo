...
set Library     "hls"
set IPName      "schedule_nodma"
set Version     "1.0"
set DisplayName "Schedule_nodma"
set Revision    "2004050106"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 con W 0x0 "Data signal of con" {{0 32 con W 0 "Bit 31 to 0 Data signal of con"}}} {0x18 BASE_ADDR_s W 0x0 "Data signal of BASE_ADDR_s" {{0 32 BASE_ADDR_s W 0 "Bit 31 to 0 Data signal of BASE_ADDR_s"}}} {0x20 CLIENT_NUM_s W 0x0 "Data signal of CLIENT_NUM_s" {{0 32 CLIENT_NUM_s W 0 "Bit 31 to 0 Data signal of CLIENT_NUM_s"}}} {0x28 SLOT_NUM_s W 0x0 "Data signal of SLOT_NUM_s" {{0 32 SLOT_NUM_s W 0 "Bit 31 to 0 Data signal of SLOT_NUM_s"}}} {0x30 CORE_NUM_s W 0x0 "Data signal of CORE_NUM_s" {{0 32 CORE_NUM_s W 0 "Bit 31 to 0 Data signal of CORE_NUM_s"}}} {0x38 MESS_NUM_s W 0x0 "Data signal of MESS_NUM_s" {{0 32 MESS_NUM_s W 0 "Bit 31 to 0 Data signal of MESS_NUM_s"}}} {0x40 b_client_s W 0x0 "Data signal of b_client_s" {{0 32 b_client_s W 0 "Bit 31 to 0 Data signal of b_client_s"}}} {0x48 e_client_s W 0x0 "Data signal of e_client_s" {{0 32 e_client_s W 0 "Bit 31 to 0 Data signal of e_client_s"}}} {0x50 b_core_s W 0x0 "Data signal of b_core_s" {{0 32 b_core_s W 0 "Bit 31 to 0 Data signal of b_core_s"}}} {0x58 e_core_s W 0x0 "Data signal of e_core_s" {{0 32 e_core_s W 0 "Bit 31 to 0 Data signal of e_core_s"}}} {0x60 ip_id_s W 0x0 "Data signal of ip_id_s" {{0 32 ip_id_s W 0 "Bit 31 to 0 Data signal of ip_id_s"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_BUS_M0 m_axi_BUS_M1 m_axi_BUS_HOST m_axi_BUS_CDMA m_axi_BUS_BUF"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_BUS_M0 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_BUS_M0"
        data_width "32"
        param_prefix "C_M_AXI_BUS_M0"
    ...
    m_axi_BUS_M1 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_BUS_M1"
        data_width "32"
        param_prefix "C_M_AXI_BUS_M1"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_BUS_HOST {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_BUS_HOST"
        data_width "32"
        param_prefix "C_M_AXI_BUS_HOST"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_BUS_CDMA {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_BUS_CDMA"
        data_width "32"
        param_prefix "C_M_AXI_BUS_CDMA"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_BUS_BUF {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_BUS_BUF"
        data_width "32"
        param_prefix "C_M_AXI_BUS_BUF"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
