...
reg   [31:0] m_d_addr_read_reg_108;
reg    ap_block_state10_pp0_stage9_iter0;
reg    ap_block_pp0_stage9_11001;
reg   [31:0] m_d_addr_read_16_reg_113;
reg    ap_block_state11_pp0_stage10_iter0;
reg    ap_block_pp0_stage10_11001;
reg   [31:0] m_d_addr_read_17_reg_118;
reg    ap_block_state12_pp0_stage11_iter0;
reg    ap_block_pp0_stage11_11001;
reg   [31:0] m_d_addr_read_18_reg_123;
reg    ap_block_state13_pp0_stage12_iter0;
reg    ap_block_pp0_stage12_11001;
reg   [31:0] m_d_addr_read_19_reg_128;
reg    ap_block_state14_pp0_stage13_iter0;
reg    ap_block_pp0_stage13_11001;
reg   [31:0] m_d_addr_read_20_reg_133;
reg    ap_block_state15_pp0_stage14_iter0;
reg    ap_block_pp0_stage14_11001;
reg   [31:0] m_d_addr_read_21_reg_138;
reg   [31:0] m_d_addr_read_22_reg_143;
reg    ap_block_state1_pp0_stage0_iter0;
reg    ap_block_state17_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] m_d_addr_read_23_reg_148;
reg   [31:0] m_d_addr_read_24_reg_153;
reg   [31:0] m_d_addr_read_25_reg_158;
wire    ap_block_state4_pp0_stage3_iter0;
reg    ap_block_state20_pp0_stage3_iter1;
reg    ap_block_pp0_stage3_11001;
reg   [31:0] m_d_addr_read_26_reg_163;
wire    ap_block_state5_pp0_stage4_iter0;
reg    ap_block_state21_pp0_stage4_iter1;
reg    ap_block_pp0_stage4_11001;
reg   [31:0] m_d_addr_read_27_reg_168;
wire    ap_block_state6_pp0_stage5_iter0;
reg    ap_block_state22_pp0_stage5_iter1;
reg    ap_block_pp0_stage5_11001;
reg   [31:0] m_d_addr_read_28_reg_173;
wire    ap_block_state7_pp0_stage6_iter0;
reg    ap_block_state23_pp0_stage6_iter1;
reg    ap_block_pp0_stage6_11001;
reg   [31:0] m_d_addr_read_29_reg_178;
...
wire  signed [63:0] sum_cast_fu_66_p1;
...
#0 sum_reg_97 = 32'd0;
#0 m_d_addr_read_reg_108 = 32'd0;
#0 m_d_addr_read_16_reg_113 = 32'd0;
#0 m_d_addr_read_17_reg_118 = 32'd0;
#0 m_d_addr_read_18_reg_123 = 32'd0;
#0 m_d_addr_read_19_reg_128 = 32'd0;
#0 m_d_addr_read_20_reg_133 = 32'd0;
#0 m_d_addr_read_21_reg_138 = 32'd0;
#0 m_d_addr_read_22_reg_143 = 32'd0;
#0 m_d_addr_read_23_reg_148 = 32'd0;
#0 m_d_addr_read_24_reg_153 = 32'd0;
#0 m_d_addr_read_25_reg_158 = 32'd0;
#0 m_d_addr_read_26_reg_163 = 32'd0;
#0 m_d_addr_read_27_reg_168 = 32'd0;
#0 m_d_addr_read_28_reg_173 = 32'd0;
#0 m_d_addr_read_29_reg_178 = 32'd0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_16_reg_113 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_17_reg_118 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_18_reg_123 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_19_reg_128 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_20_reg_133 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_21_reg_138 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_22_reg_143 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_23_reg_148 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_24_reg_153 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_25_reg_158 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_26_reg_163 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_27_reg_168 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_28_reg_173 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        m_d_addr_read_29_reg_178 <= 32'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_ST_fsm_pp0_stage1 == ap_CS_fsm) & (1'b0 == ap_block_pp0_stage1_11001))) begin
...
assign m_axi_m_d_ARADDR = sum_cast_fu_66_p1;
...
assign sum_cast_fu_66_p1 = $signed(sum_reg_97);

assign sum_fu_60_p2 = (ap_port_reg_offset + 32'd262144);
